...
//17 check if today is weekend or weekday
//18 write program print one to 100 
but print fizz if divisuibke 3
print print fizzbuzz divisible by both 3 and 5
print buzz divisible y 5
//19 writw priogram that receives strings as argument counts number of vowels contained in string
